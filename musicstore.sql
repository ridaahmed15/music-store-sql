...
join invoice on customer.customer_id=invoice.coustomer_id
...
-- Q1.write query to return email, first name, last name and genre of all rock music listener
...
-- Q3. RETURN ALLL TRACK NAMES THAT HAVE A SONG LENGTH LONGER THAN THE AVERAGE SONG LENGTH.
-- RETURN THE NAME AND MILLISECONDS FOR EACH TRACK
---ORDER BY THE SONG LENGTH WITH THE LONGEST SONGS LISTED FIRST.


select name,milliseconds from track
where millisecond > (select Avg(millisecods)as avg_track from track)
